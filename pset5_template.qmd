...
#...code  from Step 1 to access the website,
select and read in the html code, make it into
a text object, iterate through 
...
enforcement_actions_year_month = [] 
  for action in data:
    if year >= 2013:
      ...
      enforcement_actions_year_month.append()
    else:
      print("Only search for years in 2013 and later")
  return(df.csv("enforcement_actions_year_month"))
...
def year_scraper(data, month, year):
  #receiving object
  enforcement_actions_year_month = []
  

  for action in data:
    #parse year objects as datetime objects
    if year >= 2013:
      
      time.sleep(1) #will cause the scraper to delay for 2 seconds
      enforcement_actions_year_month.append(action)
    else:
      print("Only search for years in 2013 and later!")
  return(enforcement_actions_year_month.csv("enforcement_actions_year_month"))
```
