...
asked how to remove elements of a string object.
...
grouped_shape = attorney_shape.groupby("District")

#save to df
#grouped_shape = pd.DataFrame(grouped_shape)

#groupby "District" and get count of Observations
#grouped_obs_shape = attorney_shape.groupby("District")["Observations"].count()

#save to df
#grouped_obs_shape = pd.DataFrame(grouped_shape)

#add grouped_obs_shape as a column to 

#create the choropleth

grouped_shape.plot(column = "judicial_d", legend = True)
